...
- **security-response-generator/**: A local, offline CLI that generates Markdown-formatted security control responses (e.g. NIST 800-53) using local RAG over a NIST baseline, engagement-specific customer/state standards, and a private, gitignored system-context document, powered by Ollama (Phi-4-mini by default, swappable) and ChromaDB.
